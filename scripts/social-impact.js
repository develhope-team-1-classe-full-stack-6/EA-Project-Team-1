    ...
    <a href=${href} class="card">
            ...
            <div class="card-body p-4">
              <div class="d-flex flex-column align-items-center flex-md-row align-items-md-start mb-2">
                <span class="me-md-3" style="color:#03C0D2;">${type}</span>
                <span>${date}</span>
              </div>
...
function box(href, h1) {
  const box = `
  <div class="cardimpegni"><a href=${href} class="impegnilinkblue" style="text-decoration: none"><h3 class="h5">${h1}</h3></a></div>
  `;
  return box;
}
